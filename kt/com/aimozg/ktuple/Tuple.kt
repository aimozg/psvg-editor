...
external interface Tuple1<out T1> : Tuple {
	@JsName("concat")
...
external interface Tuple2<out T1, out T2> : Tuple {
	@JsName("concat")
...
external interface Tuple3<out T1,out T2,out T3> : Tuple {
	@JsName("concat")
...
external interface Tuple4<out T1,out T2,out T3,out T4> : Tuple {
	@JsName("concat")
...
external interface Tuple5<out T1,out T2,out T3,out T4,out T5> : Tuple

inline fun <T1, T2, T3, T4, T5> Tuple5(i1: T1, i2: T2, i3: T3, i4: T4, i5: T5): Tuple5<T1, T2, T3, T4, T5> =
		arrayOf(i1, i2, i3, i4, i5).asDynamic()
...
inline var <T1> MutableTuple1<T1>.i0: T1
	get() = get(0).asDynamic()
	set(value:T1) = set(0,value)
inline operator fun<T1> MutableTuple1<T1>.set(index: Int, value: T1) {
	asArray()[index] = value
}
